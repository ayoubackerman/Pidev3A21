...
public class ServiceMessages implements IService<Messages>{
    ...
    public List<Messages> selectAll() throws SQLException {
        ...
        while (rs.next()){
            ...
            User user1 = new User(rs.getInt(11),role,rs.getString(13),rs.getString(14),rs.getString(15),rs.getString(16),rs.getString(17),rs.getString(18));
           // user user2 = new user(rs.getInt(20),rs.getInt(21),rs.getString(22),rs.getString(23),rs.getString(24),rs.getString(25),rs.getString(26),rs.getString(27));
            Conversation conversation = new Conversation(rs.getInt(7),user1,rs.getDate(9),rs.getDate(10));
            ...
            p.setHeureEnvoi(rs.getTimestamp(6).toLocalDateTime());
