...
public class ServiceConversation implements IService <Conversation>{
    ...
    public List<Conversation> selectAll() throws SQLException {
        ...
        while (rs.next()){
            ...
            User us1 = new User(role,rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getString(12));
            p.setUtilisateur1(us1);
            p.setHeureDebut(rs.getDate(3));
            p.setHeureFin(rs.getDate(4));
