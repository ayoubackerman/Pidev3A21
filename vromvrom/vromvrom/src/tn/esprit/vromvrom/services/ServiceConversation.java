...
public class ServiceConversation implements IService <Conversation>{
    ...
    public void createOne(Conversation conversation) throws SQLException {
        String req = "INSERT INTO conversation (utilisateur1, utilisateur2) " +
                " VALUES (?, ?)";
    ...
    public List<Conversation> selectAll() throws SQLException {
        ...
        String req = "SELECT *" +
                "FROM conversation" +
                " JOIN user u1 ON Conversation.utilisateur1 = u1.id_user" +
        ...
        while (rs.next()){
            ...
            user us1 = new user(rs.getInt(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getString(12),rs.getString(13));
