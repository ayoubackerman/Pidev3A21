...
public class AfficherVoituresController implements Initializable {
    ...
    @FXML
    private TableColumn<Voiture, String> img;
    @FXML
    ...
    public void table() {
        ...
        Prenom.setCellValueFactory((CellDataFeatures<Voiture, String> cellData) -> {
            User user = cellData.getValue().getUser();
            return new SimpleStringProperty(user.getPrenom());
        });
    ...
    private void update(ActionEvent event) {
        ...
        if (((((up_id.getText().isEmpty() 
                || up_id.getText().isEmpty()) 
                || up_modele.getText().isEmpty()) 
                || up_marque.getText().isEmpty()) 
                || up_matricule.getText().isEmpty())) {
    ...
    private void retrieve(MouseEvent event) {
        try{
            Voiture voiture = table.getSelectionModel().getSelectedItem();
            up_id.setText(Integer.toString(voiture.getUser().getId_user()));
    ...
    private void back(ActionEvent event) {
        try {
            Parent main = FXMLLoader.load(getClass().getResource("AjouterVoiture.fxml"));
