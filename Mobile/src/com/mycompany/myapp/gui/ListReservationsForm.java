 ...
 * @author rihem
 */
public class ListReservationsForm extends BaseFormBack {

    public ListReservationsForm(Form previous,Resources res) throws IOException {
        ...
        list = new ArrayList<>();
        list = ServiceReservation.getInstance().getAll();
        ...
        for ( Reservation p : list) {
         ...
         Label spl = new Label("Reservatin Id: " + "  " + p.getIdReservation()); 
         spl.getAllStyles().setFgColor(0x00000);
         Label spl2 = new Label("Ville de depart: " + "  " + p.getIdTrajet().getVilleDepart()); 
         spl2.getAllStyles().setFgColor(0x00000);
        
          Label spl7 = new Label("Ville d arrivé: " + "  " + p.getIdTrajet().getVilleDarrive());
          spl7.getAllStyles().setFgColor(0x00000);
         Label spl5 = new Label("Chauffeur : " + "  " + p.getIdUser().getMail());
         ...
         Button sup = new Button("Delete");
                ...
                sup.addActionListener((evt) -> {
                   ServiceReservation.getInstance().Supprimer(p.getIdReservation());
                    ...
                    Dialog.show("Success", "Reservation deleted successfully", new Command("OK"));
                     ...
                     Message m = new Message("Your Reservation has been deleted successfully !");
                        Display.getInstance().sendMessage(new String[] {"abrar.bouslahi@esprit.tn"}, "Confirmation", m);
                    });
                 upd.addActionListener((evt) -> {
                        new EditReservationForm(this.getComponentForm(),res,p).show();
                    });
