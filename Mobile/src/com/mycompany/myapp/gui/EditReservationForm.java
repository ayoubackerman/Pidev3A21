 ...
 * @author rihem
 */
public class EditReservationForm extends BaseFormBack {

    public EditReservationForm(Form previous,Resources res,Reservation id) {
         super("liste des reservations", BoxLayout.y());
...
/*End Trajet*/
        ...
        Button btnValider = new Button("Edit reservation");
...
int idTrajet = trajets.get(trajetsCB.getSelectedIndex()).getIdTrajet();
                        ...
                        if(ServiceReservation.getInstance().update(idUser,idTrajet,id.getIdReservation()))
